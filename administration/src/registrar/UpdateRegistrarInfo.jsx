...
const UpdateRegistrarInfo = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Change Profile info for registrar
            await axios.put(`http://localhost:8800/registrar/${user._id}`, data)
                .then(res => {
                    console.log(res)
    ...
    useEffect(() => {
        // Get A single registrar
        axios.get("http://localhost:8800/registrar/" + user._id)
            .then(response => {
                setregistrar(response.data[0])
            })
            .catch(error => {
                setError(error.message)
                    ...
                    <div className="flex flex-col h-screen">
                        ...
                        <div className="pl-10 pb-4 pt-2 sm:px-16 md:px-8 sm:py-8 overflow-scroll" >
                            ...
                            <div className="text-center mb-8 text-2xl">
                                <span className="p-3">Username: </span>  {registrar.username}
                            </div>
...
export default UpdateRegistrarInfo
