...
export default function SignupAdmin() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (admin.stationid === 0) {
            ...
            try {
                // Register Admin
                await axios.post("http://localhost:8800/admin/signup", data, config)
                    .then(() => {
            ...
            <div className="flex flex-row h-screen">
                ...
                <div className="pl-2 flex-1">
                    <div className="flex flex-col h-screen">
                        <div className="h-16 w-full flex flex-col text-center bg-black text-white">
                            <h1 className='font-semibold text-base sm:text-2xl'>Register Admin</h1>
